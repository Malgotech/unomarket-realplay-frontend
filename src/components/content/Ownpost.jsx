...
const Ownpost = () => {
    ...
    // console.log('thoughtssss :>> ', thoughts);
    ...
    return (
        <div className="relative ">
            <div className="relative ">
                <div className="flex flex-col gap-1 lg:flex-row relative w-full  ">
                    {/* Left column with vertical borders extending to include the title */}
                    <div
                        className={`  relative    w-full  border-l border-r ${isDarkMode ? "border-zinc-600" : "border-gray-300"
                            }`}
                    ...
                    >
                        ...
                        <div className="px-0 relative">
                            {/* Top divider line */}
                            <div
                                className={`w-full ${isDarkMode ? "bg-zinc-600" : "bg-gray-300"
                                    } mb-4`}
                            ></div>
                            ...
                            {isLoading ? (
                                ...
                                <div className={`mb-5 p-4 mx-6`}>
                                    ...
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <span
                                            className={`text-[15px] sm:text-[18px] ${isDarkMode ? "text-white" : "text-gray-900"
                                                } font-medium`}
                                        >
                                    ...
                                    <textarea
                                        ...
                                        className={`w-full min-h-[40px] max-h-[200px] p-2 text-[13px] sm:text-[17px] rounded-lg resize-none focus:outline-none ${isDarkMode
                                    ...
                                    <div className="mt-1 flex justify-end">
                                        <button
                                            onClick={async () => {
                                                setError("");
                                                if (!content.trim()) {
                                                    setError("Cannot post empty thought");
                                                    return;
                                                }
                                                try {
                                        ...
                                        {Array(5)
                                            ...
                                            .map((_, index) => (
                                                <React.Fragment key={`skeleton-${index}`}>
                                                    ...
                                                    {index < 4 && (
                                                        <div
                                                            className={`h-px w-[calc(100%+3rem)] -ml-6 ${isDarkMode ? "bg-zinc-600" : "bg-gray-300"
                                                                } my-2`}
                                                        ></div>
                                                    )}
                                                </React.Fragment>
