    ...
    <div className="relative ">
      <div className="relative ">
        <div className="flex flex-col gap-1 lg:flex-row relative w-full  ">
          ...
          <div
            className={`  relative    w-full  border-l border-r ${
              ...
              {isLoading ? (
                ...
                <div className={`mb-5 p-4 mx-6`}>
                  ...
                  <textarea
                    ...
                    className={`w-full min-h-[40px] max-h-[200px] p-2 text-[13px] sm:text-[17px] rounded-lg resize-none focus:outline-none ${
                      isDarkMode
              ...
              <div className="mx-6">
                {isLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-[50vh] text-center">
                    <i
                      className={`ri-chat-3-line text-5xl mb-4 ${
